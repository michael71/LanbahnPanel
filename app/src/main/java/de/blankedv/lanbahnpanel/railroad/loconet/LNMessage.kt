 ...
 *
 * a textual interpretation of some LN Messages can be generated by calling the fun interpret()
 *
...
open class LNMessage {
    ...
    /** make LNMessage-Hex-String from IntArray, add checksum */
    constructor(d: IntArray) {
        ...
        msgXStr[len-1] = String.format("%02X",( checksum.inv() and 0xff))
